...
import ButtonContact from "../layouts/ButtonContact.jsx";
import DarkModeToggle from "../layouts/DarkModeToggle.jsx";
    ...
    return (
        <>
            <div className="fixed w-full z-50">
                <div>
                    <div
                        className="flex flex-row justify-between p-5 md:px-32 px-5 bg-white dark:bg-slate-900 shadow-[0_3px_10px_rgba(0,0,0,0.2)]">
                        <div className="flex flex-row items-center cursor-pointer dark:text-gray-200">
                            <span>
                                <BiRestaurant size={32}/>
                            </span>
                            <h1 className="text-xl font-bold text-slate-800 dark:text-gray-200 uppercase">RestoWeb</h1>
                        </div>
                        <nav className="hidden md:flex flex-row items-center lg:text-sm font-semibold gap-8 text-slate-800 dark:text-gray-200">
                    ...
                    <div
                        ...
                        } lg:hidden flex flex-col absolute bg-white text-brightColor left-0 top-15 z-0 shadow-lg font-semibold text-md text-center pt-8 pb-4 px-3 gap-8 w-full h-fit transition-transform duration-700`}
                    >
                        <Link to="home" spy={true} smooth={true} duration={2000}
