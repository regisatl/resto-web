...
const Footer = () => {
    return (
        <footer className="bg-gray-100 text-slate-800 dark:bg-slate-900 dark:text-gray-200 py-10 border dark:border-slate-800">
            <div className="container mx-auto px-5 lg:px-20">
                <div className="flex flex-col lg:flex-row justify-between gap-10">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="dark:text-gray-400">123 Foodie Street, Gourmet City</p>
                        <p className="dark:text-gray-400">Phone: +1 234 567 890</p>
                        <p className="dark:text-gray-400">Email: contact@foodie.com</p>
                    </div>
                </div>
                ...
                <div className="mt-10 border-t border-gray-700 pt-5 text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        <a href="#" className="p-3 bg-gray-800 text-gray-200 rounded-full hover:bg-brightColor transition-all duration-700">
                            <FaFacebookF/>
                        </a>
                        <a href="#" className="p-3 bg-gray-800 text-gray-200 rounded-full hover:bg-brightColor transition-all duration-700">
                            <FaTwitter/>
